...
// Returns information about the system that talon is running on.
...
// Creates a new server on the talon instance and begins the installation process
// for it.
...
// Updates the running configuration for this Talon instance.
